...
Public Class DataOperations
    ...
    ''' with null values yet we need to expect nulls in real 
    ''' applications so the method below this one shows one 
    ''' way to do so.
    ''' </summary>
    ...
    End Function
    ''' <summary>
    ''' Performs same assignments as above but with 
    ''' language extension method.Which one is better? 
    ''' Neither, the one above is perfectly fine if you have
    ''' but one place you are constructing a class instance 
    ''' while the method below is utilizing extension methods 
    ''' which can be used any place
    ''' </summary>
    ''' <param name="pReader"></param>
    ''' <param name="pIdentifier"></param>
    ''' <returns></returns>
